...
export default class SolutionContainer extends React.Component {
  constructor(props){
        ...
        var self = this;
        window.scrollTo(0,0);
        return axios.get('http://ec2-13-58-19-50.us-east-2.compute.amazonaws.com:10000/auth/solutions/problemID?id='+this.props.params.probID).then(function (response) {
            self.setState({
