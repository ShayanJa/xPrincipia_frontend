...
export default class CreatedSolution extends React.Component {
   render() {
      return (

        <div id="createdSolutionComponent">
          ...
          <div id="solution">
            ...
            <div id="solutionFutureExperiments">
