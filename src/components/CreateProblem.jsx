            ...
            <fieldset>
                ...
                <legend>Create: Solution</legend>
                  ...
                  <label for="solutiondescription">Description<br />
                      <textarea name="solutiondescription" required="required"></textarea></label><br />

                  <label for="solutionevidence">Evidence/Logic<br /><textarea name="solutionevidence"></textarea></label><br />
